...
class ItemFromCamera extends StatefulWidget {
  ...
  ItemFromCamera({Key key, this.imageFile, this.clothing}) : super(key: key);
...
class _ItemFromCameraState extends State<ItemFromCamera> {
  ...
  @override
  void initState() {
    if (widget.imageFile != null && widget.clothing != null) {
  ...
  void _onButtonPressed() {
    if (_imageFile != null) {
      ...
      CommonMethods.showSnack(context, 'Пожалуйста, сделайте фото');
    }
  }
