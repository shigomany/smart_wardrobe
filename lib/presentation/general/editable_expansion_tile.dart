...
class _EditableExpansionTileState extends State<EditableExpansionTile>
  ...
  void initState() {
    ...
    _heightFactor = _controller.drive(EditableExpansionTile._easeInTween);
    _iconTurns = _controller.drive((widget.animatedWidgetTurnTween ??
            EditableExpansionTile._halfTween)
        .chain(
            widget.animatedWidgetTween ?? EditableExpansionTile._easeInTween));

    _borderColor = _controller.drive(_borderColorTween.chain(
        widget.borderAnimationTween ?? EditableExpansionTile._easeOutTween));
    _borderColorTween.end = widget.borderColorEnd;

    _headerColor = _controller.drive(_headerColorTween.chain(
        widget.headerAnimationTween ?? EditableExpansionTile._easeInTween));
